...
import { FiSearch, FiCalendar, FiUsers, FiPlus, FiMinus, FiMapPin } from 'react-icons/fi';
...
                params: { origin, destination, travelDateTime, passengerCount },
...
            setIsLoading(false);
        }
    }, [origin, destination, travelDateTime, passengerCount, showNotification]);
    useEffect(() => {
        if (
...
        setSearchParams({ origin, destination, travelDateTime, passengerCount });
    };
    const handleReset = () => {
        setOrigin('');
        setDestination('');
